  ...
  return knex('ACCOUNT').del()
    .then(function() {
      return knex('ACCOUNT').insert([
        { EMPLOYEE_ID: 1, EMP_NAME: 'Admin User', EMP_ROLE: 'Admin', ACCESS_LEVEL: 1, USERNAME: 'Phuc', USER_PASSWORD: 'gsP5Um5JsSg5DPk0wXmumKO/nY9oJKHtNqqs85CpGHU=:810cd2d9-bee5-4107-aead-b2d15d0e7a77', EMAIL: 'admin123@gmail.com', SALARY: 3000000 },
        { EMPLOYEE_ID: 2, EMP_NAME: 'Tester 1', EMP_ROLE: 'Staff', ACCESS_LEVEL: 2, USERNAME: 'PhanPhuc', USER_PASSWORD: 'A+ukDEN5YwOoLTst0nrbCdNq4LOhJTVUad2vExY2YQ0=:87fa11bd-f1bd-4b98-a794-0b4dddb4b2aa', EMAIL: 'php2692004@gmail.com', SALARY: 3000000 },
